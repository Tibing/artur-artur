...
function insertNextItemToPlaylist(contentType, pluginPath, callback) {
  getPlaylistId(contentType, function (playlistId) {
    var insertToPlaylist = '{"jsonrpc": "2.0", "method": "Playlist.Insert", "params":{"playlistid":' + playlistId + ', "item" :{ "file" : "' + pluginPath + '" }}, "id" : 1}';
