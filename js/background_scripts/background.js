...
chrome.runtime.onMessage.addListener((request, sender, sendResponse) => {
  if (request.action === 'playVKAudio') {
    addItemsToPlaylist([ { 'contentType': 'audio', 'pluginPath': request.link } ], sendResponse);
  }

  if (request.action === 'playVKAudio.loadNextRes') {
    insertItemToPlaylist('audio', request.link, request.active, () => {});
  }
});
